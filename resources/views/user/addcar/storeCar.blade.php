...
@section('content')
    <div class="card mb-3">
        <div class="row g-0">
            <div class="col-md-4">
                <img src="{{ asset('/storage/media/'. $viewData['car']->getImage()) }}" class="img-fluid rounded-start" alt="Image not found">
            </div>
            <div class="col-md-8">
                <div class="card-body">
                    <h5 class="card-title">
                    ...
                    <img src="{{ asset('/storage/media/'. $viewData['user']->getImage()) }}" class="img-fluid rounded-start" alt="Image not found">
